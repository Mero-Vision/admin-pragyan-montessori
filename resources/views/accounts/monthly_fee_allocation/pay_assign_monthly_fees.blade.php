                                        ...
                                        <div class="table-responsive">
                                            <table class=" table-invoice">
                                                ...
                                                <tbody>
                                                    ...
                                                    @forelse ($monthlyFeesPaymentDetails as $monthlyFeesPaymentDetail)
                                                        <tr>
                                                            <td>{{ $counter }}</td>
                                                            <td>
                                                                <p>{{ $monthlyFeesPaymentDetail->particulars }}</p>
                                                                <input type="hidden"
                                                                    value="{{ $monthlyFeesPaymentDetail->particulars }}"
                                                                    name="particulars[{{ $counter }}][particular_name]" />
                                                            </td>
                                                            <td>
                                                                <input class="form-control py-0 my-0 amount-input"
                                                                    type="number"
                                                                    value="{{ $monthlyFeesPaymentDetail->amount }}"
                                                                    name="particulars[{{ $counter }}][particular_amount]">
                                                            </td>
                                                        </tr>
                                                        @php
                                                            $counter++;
                                                        $totalAmount += $monthlyFeesPaymentDetail->amount; @endphp
                                                    @empty
                                                        <tr>
