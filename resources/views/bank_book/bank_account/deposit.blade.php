            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Deposit Amounts to {{ $bankAccount->bank_name }}</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ url('admin/bank-book') }}">Bank Book</a></li>
                                <li class="breadcrumb-item active">Deposit Amounts to {{ $bankAccount->bank_name }}</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ url('admin/bank-book/' . $bankAccount->slug . '/deposit') }}"
