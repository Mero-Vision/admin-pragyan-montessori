            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Student Admission Inquiry List</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">@lang('translation.dashboard')</a>
                                </li>
                                <li class="breadcrumb-item active">Student Admission Inquiry List</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <script>
            $(document).ready(function() {
                $('#table_data').DataTable({
                    ajax: {
                        url: '/admin/cms/admission-inquiry/data',
                        type: 'GET',
                        dataType: 'json',
                        processing: true,
                        serverSide: true,
