<div class="header">
            ...
            <div class="header-left">
                ...
                <a href="{{url('admin/dashboard')}}" class="logo logo-small">
                    <img src="{{url('assets/img/logo.jpg')}}" alt="Logo" width="30" height="30">
                </a>
            </div>
            ...
            <ul class="nav user-menu">
                <li class="nav-item dropdown noti-dropdown language-drop me-2">
                    <a href="#" class="dropdown-toggle nav-link header-nav-list" data-bs-toggle="dropdown">
                        <img src="{{url('assets/css/flags/lr.png')}}" alt="language-logo" style="width: 20px;" class="rounded">
                    </a>
                    <div class="dropdown-menu ">
                        <div class="noti-content">
                            <div>
                                ...
                                <a class="dropdown-item" href="javascript:;"><i
                                        class="flag flag-np me-2"></i>Nepali</a>
                ...
                <li class="nav-item dropdown noti-dropdown me-2">
                    <a href="#" class="dropdown-toggle nav-link header-nav-list" data-bs-toggle="dropdown">
                        <img src="{{url('assets/img/header-icon-05.svg')}}" alt>
                    </a>
