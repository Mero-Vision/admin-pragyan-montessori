                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <div class="page-header">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h3 class="page-title">Create New Announcement</h3>
                                </div>
                            </div>
                        </div>
                        <form action="{{ url('admin/cms/announcements/create') }}" method="POST"
                            ...
                            <div class="card">
                                ...
                                <div class=" blog-categories-btn pt-0">
                                    <div class="bank-details-btn ">
                                        <a href="{{url('admin/cms/announcements')}}" class="btn btn-primary">Return Back</a>
