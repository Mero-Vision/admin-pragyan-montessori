            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Announcements List</h3>
                            <ul class="breadcrumb">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="search-student-btn">
                            <a href="{{ url('admin/cms/announcements/create') }}" class="btn btn-primary">Add New
                                Announcement</a>
                        </div>
        ...
        <script>
            $(document).ready(function() {
                $('#table_data').DataTable({
                    ajax: {
                        url: '/admin/cms/announcements/data',
                        type: 'GET',
                        dataType: 'json',
                        processing: true,
                        serverSide: true,
                    ...
                    "columns": [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                ...
                                var truncatedContent = data.split(' ').slice(0, 10).join(' ');
