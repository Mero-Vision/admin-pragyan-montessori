            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Monthly Fees Invoice Particulars</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a
                                        href="{{ url('admin/accounts/student-monthly-fees-payments') }}">Monthly Fees
                                        Payment</a></li>
                                <li class="breadcrumb-item active">Monthly Fees Invoice Particulars</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ url('admin/accounts/monthly-fees-particulars') }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-12">
                                            <h5 class="form-title"><span>Create Monthly Fees Invoice Particulars</span>
                                            </h5>
                                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped custom-table" id="table_data">
                                        ...
                                        <tbody>
                                            @foreach ($monthlyFeesParticulars as $monthlyFeesParticular)
                                                <tr>
                                                    ...
                                                    <td>{{ $monthlyFeesParticular->user }}</td>
                                                    <td>
                                                        <a class="btn btn-danger px-2 py-1 delete-data"
                                                            data-admission-id="{{ $monthlyFeesParticular->id }}"><i
                                                                class='bx bxs-message-square-x bx-sm'></i></a>
                                                        <a class="btn btn-primary px-2 py-1"
                                                            href="{{ url('admin/accounts/monthly-fees-particulars/edit') }}/{{ $monthlyFeesParticular->id }}"><i
                                                                class='bx bxs-message-square-edit bx-sm'></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
            ...
            $(document).ready(function() {
                $('.delete-data').on('click', function(e) {
                    ...
                    $('#confirmDeleteBtn').attr('href',
                        "{{ url('admin/accounts/monthly-fees-particulars/delete') }}/" + userId);
