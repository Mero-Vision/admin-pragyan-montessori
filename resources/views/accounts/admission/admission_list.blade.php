            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Recent Admission List</h3>
                            <ul class="breadcrumb">
                                    ...
                                    <table class="table table-striped custom-table" id="table_data">
                                        ...
                                        <tbody>
                                            @foreach ($admissionLists as $admissionList)
                                                <tr>
                                                    <td>{{ $admissionList->id }}</td>
                                                    <td>{{ $admissionList->name }}</td>
                                                    <td>{{ $admissionList->admission_id }}</td>
                                                    <td>{{ $admissionList->admission_date }}</td>
                                                    <td>
                                                        @if ($admissionList->payment_status === 'pending')
                                                            <span
                                                                class="badge bg-danger">{{ $admissionList->payment_status }}</span>
                                                        @elseif($admissionList->payment_status === 'paid')
                                                            <span
                                                                class="badge bg-success">{{ $admissionList->payment_status }}</span>
                                                        @endif
                                                    </td>

                                                    <td>
                                                        @if ($admissionList->payment_status === 'pending')
                                                            <a  class="btn btn-danger">Go to Payment</a>
                                                        @elseif($admissionList->payment_status === 'paid')
