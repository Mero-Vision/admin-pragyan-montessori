            ...
            <div class="content container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-xl-4 text-center">
                        <h3 class="m-gray">Add Income</h3>
                        <hr>
                        <form action="{{url('admin/day-book/add-income')}}" method="POST">
                            @csrf
                            ...
                            <input  list="" id="input" class="form-control m-t-10"
                                placeholder="Income Description" name="description" autocomplete="off">
                                 @error('description')
                                <p class="text-danger">{{$message}}</p>
                            @enderror
                            ...
                            <input type="number" name="income_amount" step="any" class="form-control m-t-10"
                                placeholder="Income Amount">
                                 @error('income_amount')
                                <p class="text-danger">{{$message}}</p>
                            @enderror
                            <hr>
                            <button type="submit" class="submit btn btn-primary"><i class="bi bi-check2-circle"></i> Submit</button>
                        </form>
                    </div>
                    <div class="col-md-6 col-xl-4"></div>
                </div>
