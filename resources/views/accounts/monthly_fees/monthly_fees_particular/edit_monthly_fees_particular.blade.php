                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <form
                                    action="{{ url('admin/accounts/monthly-fees-particulars/update') }}/{{ $monthlyFeesParticulars->id }}"
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="text" class="form-control" name="particular_name"
                                                    ...
                                                    value="{{ $monthlyFeesParticulars->particulars }}">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="number" class="form-control" name="amount"
                                                    ...
                                                    value="{{ $monthlyFeesParticulars->amount }}">
                                                @error('amount')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="number" class="form-control"
                                                    ...
                                                    value="{{ $monthlyFeesParticulars->order_number }}">
                                                @error('order_number')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                            </div>
